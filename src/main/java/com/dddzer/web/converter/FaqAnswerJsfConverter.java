...
/**
 * JSF Converter for {@link FaqAnswer}.
 */
@Named
@Singleton
public class FaqAnswerJsfConverter extends GenericJsfConverter<FaqAnswer, Integer> {
    @Inject
    public FaqAnswerJsfConverter(FaqAnswerRepository faqAnswerRepository) {
        super(faqAnswerRepository, FaqAnswer.class, Integer.class);
    }
}
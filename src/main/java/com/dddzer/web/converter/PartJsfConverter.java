...
/**
 * JSF Converter for {@link Part}.
 */
@Named
@Singleton
public class PartJsfConverter extends GenericJsfConverter<Part, Integer> {
    @Inject
    public PartJsfConverter(PartRepository partRepository) {
        super(partRepository, Part.class, Integer.class);
    }
}